(function (root) {
  ...
  function validTexture(t) {
    return !!t && typeof t.url==='string' && /^assets-[a-z0-9]+\/animate\/[a-zA-Z0-9_./@-]+\.png$/.test(t.url) && !t.url.includes('..') &&
  ...
  const api={VERSION,validFrame,validTexture,compatible,interpolate,sample,liveSample,validateRecording};
